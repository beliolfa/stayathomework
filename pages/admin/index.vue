      ...
      <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
        ...
        >
          <table class="min-w-full">
            ...
            <tbody>
              <tr v-for="subjectItem in subjects" :key="subjectItem.slug" class="bg-white">
                ...
                <td
                  class="px-6 py-4 .whitespace-no-wrap max-w-xs text-sm leading-5 text-gray-700 truncate"
                >
